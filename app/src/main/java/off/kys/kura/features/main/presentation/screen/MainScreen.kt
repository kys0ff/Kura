            ...
            LazyColumn(
                ...
                item {
                    AppSelectionHeader(
                        ...
                        // Pass the current active filters to the header UI
                        activeFilters = state.activeFilters,
                        onFilterChanged = { badges ->
                            viewModel.onEvent(MainUiEvent.FilterApps(badges))
                        }
                    )
                }

                // IMPORTANT: Use state.filteredApps instead of state.installedApps
                ...
                if (state.filteredApps.isEmpty())
                    item {
                        Text(
                            text = stringResource(R.string.no_apps_match_these_filters),
